...
if(isset($_POST['pid'])){
    ...
    if(!$code){
        $query =$con->prepare("INSERT INTO cart (product_name,product_price,product_image,qty,total_price,product_code) 
            VALUES (?,?,?,?,?,?)");
        ...
        <strong>Item added to your card!</strong>  </div>';
    }else{
        echo '<div class="alert alert-danger alert-dismissible mt-3">
        <button type="button" class="close" data-dismiss="alert">&times;</button>
        <strong>Item alreday added to your card!</strong>  </div>';
    }
}
...
if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
    ...
    <h2 class="text-success">Your Order Placed Succcessfully!</h2>
